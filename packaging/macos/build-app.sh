...
ICNS="packaging/icons/icon.icns"
APP="sd2snes Covers.app" # must match Name in FyneApp.toml
...
# Swap fyne's auto-generated icon for our hand-built multi-resolution .icns
# (16..512 + Retina @2x), regenerated by packaging/genicons/genicons.sh.
if [ -f "$ICNS" ] && [ -d "$APP/Contents/Resources" ]; then
